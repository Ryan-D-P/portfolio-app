    ...
    return (
        <div className="Resume">
            ...
            <div className="sections-column">
                <section className={ `resume-section education-section${" orange-theme-bg"}` }>
                    <h2 className={ `orange-theme-color` }>Education</h2>
                ...
                <section className={ `resume-section experience-section${" orange-theme-bg"}` }>
                    <h2 className={ `orange-theme-color` }>Experience</h2>
                ...
                <section className={ `resume-section skills-section${" orange-theme-bg"}` }>
                    <h2 className={ `orange-theme-color` }>Skills</h2>
